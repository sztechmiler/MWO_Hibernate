...
public class SchoolClassesController {
    ...
    public String editSchoolClass(
    	...
    	DatabaseConnector.getInstance().editSchoolClass(profile, Integer.parseInt(startYear), Integer.parseInt(currentYear), schoolClassId);    	
       	model.addAttribute("schoolClasses", DatabaseConnector.getInstance().getSchoolClasses());
